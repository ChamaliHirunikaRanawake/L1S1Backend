...
router.route('/:id').get((req,res)=>{
    var appointmentId = req.params.id;  // This property is an object containing properties mapped to the named route “parameters”.
                     // For example, if you have the route /appoinment/:id, then the “id” property is available as req.params.name. 
